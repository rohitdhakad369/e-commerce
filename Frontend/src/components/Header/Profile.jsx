    ...
    <div className="flex justify-between md:justify-around items-center md:gap-4 md:ml-4 ">
        ...
        >
          <span
            className={`absolute ml-5 mb-5 px-1 rounded-full text-white text-sm ${
              wishlistItems.length == 0 ? "hidden " : "bg-gray-800"
            }`}
          >
            {wishlistItems.length}
          </span>
          <svg
            className="hover:bg-gray-800 rounded-full w-6 md:w-8 md:h-8"
            viewBox="0 0 32 32"
            fill="none"
      ...
      <Link to="/cart">
        ...
        >
          <span
            className={`absolute ml-5 mb-5 px-1 rounded-full text-white text-sm ${
              cartItems.length == 0 ? "hidden " : "bg-gray-500"
            }`}
          >
            {cartItems.length}
          </span>
      ...
      {currentUser && (
        <>
          ...
          >
            <svg
              className="hover:bg-gray-700 rounded-full w-6 md:w-8 md:h-8"
              viewBox="0 0 32 32"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
