          ...
          <div className="flex flex-col gap-6 md:w-[710px]">
            ...
            <div className="ml-auto flex items-center gap-8 text-sm md:text-base ">
              ...
              <button
                ...
                className="text-sm md:text-lg bg-slate-800 text-white px-6 md:px-12 py-3 rounded hover:bg-red-500 transition-transform duration-100 transform hover:translate-y-[-4px] focus:translate-y-0"
              >
