      ...
      <div className="flex flex-col items-center mt-12 mx-auto">
        <div className="flex flex-col justify-center gap-4 items-center text-center">
          ...
          <h6 className="text-xs md:text-xl">
            ...
            <span className="mx-3">
              <Fab>
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-200 opacity-30 hover:opacity-80"></span>
                <span className="flex justify-center items-center  bg-gray-700 rounded-full w-14 h-14 text-white font-semibold">
                  {countdown}
                </span>
              </Fab>
            </span>
