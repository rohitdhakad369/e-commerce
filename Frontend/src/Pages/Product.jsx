                ...
                <div className="font-inter text-xl flex gap-4">
                  <div className="border-2 w-[160px] border-gray-400 rounded text-xl font-semibold flex justify-between items-center">
                    <button
                      ...
                      className="border-r-2  hover:bg-gray-800 hover:text-white border-gray-400 rounded p-3"
                    >
                      <svg
                        width="24"
                        height="24"
                    ...
                    <button
                      ...
                      className="border-l-2  hover:bg-gray-800 hover:text-white border-gray-400 rounded p-3 "
                    >
                      <svg
                        width="24"
                        height="24"
